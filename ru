...
# SECTION 13.6b: FORK MANAGEMENT HELPERS
# Note: cmd_fork_status/sync/clean defined in SECTION 8.4; helpers below
# are used by E2E tests and other callers.
...
#   Returns 0 if polluted, 1 if clean
#------------------------------------------------------------------------------
